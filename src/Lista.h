...
class Lista {
    ...
    private:
        ...
        struct Nodo {
            ...
            Nodo(const int &elem);
            Nodo* _antptr; //referencia nodo anterior
            int _valor;
            Nodo* _sigptr; //referencia a nodo siguiente
            ~Nodo();

        };

        Nodo* buscar(Nat elem);
        Nodo* buscar(Nat elem) const;

        int _longitud;
        Nodo* _primptr; //referencia a primer nodo
        Nodo* _ultptr;  //referencia a ultimo nodo
